    ...
    return (
        ...
        <div class="row">
            <div class="col-md-12" id="about">
                ...
                <p class="font" style="font-size:18px">My name is Erika Zibelnik and I currently reside in Melbourne, Florida. I am learning
                    ...
                    creativity.</p>
                <p style="font-size:18px">I have a diverse background which enables me to adapt and problem solve as needed. This is
                ...
                <p>
                <a id="email" href="mailto:e.m.zibelnik@gmail.com" style="font-size:18px">Email me at e.m.zibelnik@gmail.com</a>
                <br />
                <a id="phone" href="tel:4403829494" style="font-size:18px">Call me at (440) 382-9494</a>
                <div>
                </div>
                </p>
            </div>
